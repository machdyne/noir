...
In addition to updating to this bitstream (`images/noir_dual.bit`), make sure you copy the `linux/noir_dual.dtb` file to the SD card and update `boot.json` to use `noir_dual.dtb`.
